...
def deconvolution(func: Callable) -> Callable:
    ...
    @click.option(
        ...
        is_flag=True,
        help=(
            "If this flag is set, the deconvolution is skipped for models that already exist in "
            "the output folder are skipped."
        ),
    )
    @force(
        help=(
